    ...
    def image_option():
        ...
        def detectByPathImage(path):
            ...
            def img_gen_report():
                ...
                pdf.image('Images/Count_Report.jpg', x=0, y=0, w=210, h=297)

                pdf.text(135, 166, str(max_count1))
    ...
    def video_option():
        ...
        def detectByPathVideo(path, writer):
            ...
            def vid_gen_report():
                ...
                pdf.text(135, 166, str(max_count2))
    ...
    def camera_option():
        ...
        def detectByCamera(writer):
            ...
            def cam_gen_report():
                ...
                pdf.text(135, 166, str(max_count3))
